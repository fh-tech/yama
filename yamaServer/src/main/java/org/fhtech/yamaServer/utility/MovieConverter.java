...
//    public static List<Movie> convertToXMLMovies(Iterable<Movie> movies) {
//        var xmlMovies = new ArrayList<Movie>();
//        movies.forEach(domainMovie -> xmlMovies.add(convertToXMLMovie(domainMovie)));
//        return xmlMovies;
//    }
//
//    public static Movie convertToXMLMovie(Movie movie) {
...
//
//
//    private static Genre convertToXMLGenre(Genre genre) {
//        switch (genre) {
//            case DRAMA:
//                return Genre.DRAMA;
//            case ACTION:
